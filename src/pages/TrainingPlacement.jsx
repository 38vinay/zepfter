...
const TrainingPlacementPage = () => {
  ...
  return (
    <div style={{ background: '#0a0a1f', minHeight: '100vh', paddingTop: '70px' }}>
      ...
      <section 
        style={{
          background: 'linear-gradient(135deg, #0a0a1f 0%, #00AA8A 50%, #1E3679 100%)',
      ...
      <section style={{ padding: '80px 20px' }}>
        <div className="container" style={{ maxWidth: '1400px' }}>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="text-center mb-5">
            <h2 className="fw-bold text-white mb-3" style={{ fontSize: 'clamp(2rem,4vw,3rem)' }}>Our Training & Placement Services</h2>
            <p className="text-white mx-auto" style={{ maxWidth: '700px', opacity: 0.8 }}>Comprehensive career support to launch your professional journey</p>
          </motion.div>
                  ...
                  {expandedService === service.id && (
                    ...
                    >
                      <div style={{ padding: '40px', color: 'white' }}>
                        ...
                        <h3 className="fw-bold mb-4" style={{ color: '#00AA8A' }}>What's Included</h3>
                        ...
                        {/* Outcomes */}
                        <h4 className="fw-bold mb-3" style={{ color: '#00AA8A' }}>What You'll Achieve</h4>
                        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginBottom: '30px' }}>
      ...
      <section style={{ padding: '80px 20px', background: 'rgba(0,170,138,0.1)' }}>
        <div className="container">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="text-center mb-5">
            <h2 className="fw-bold text-white">Why Choose ZEPFTER Training & Placement?</h2>
            <p className="text-white" style={{ maxWidth: '700px', margin: 'auto', opacity: 0.8 }}>
              Transform your career with India's most comprehensive placement support program.
            </p>
          </motion.div>
      ...
      <section style={{ padding: '80px 20px', background: 'rgba(255,255,255,0.03)' }}>
        <div className="container">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="text-center mb-5">
            ...
            <p className="text-white" style={{ maxWidth: '700px', margin: 'auto', opacity: 0.8 }}>
              Everything you need to know about our placement assistance program.
            </p>
          </motion.div>
      ...
      <section style={{ padding: '80px 20px', background: 'rgba(30,54,121,0.1)' }}>
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="text-center mb-5">
            <h2 className="fw-bold text-white">Success Stories</h2>
            <p className="text-white" style={{ maxWidth: '700px', margin: 'auto', opacity: 0.8 }}>
              Real achievements from our placed students
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                story: "ZEPFTER's placement team helped me prepare for interviews with personalized coaching. The mock interviews were exactly like real ones. Got placed in just 45 days!"
              },
              {
                name: "Priya Nair",
                ...
                story: "The resume building and LinkedIn optimization helped me get noticed by recruiters. Interview preparation sessions gave me the confidence to ace all rounds."
              },
              {
                name: "Rahul Verma",
                role: "Data Scientist",
                ...
                story: "Aptitude training and technical interview prep were game-changers. The placement coordinator personally referred me to 5 companies. Grateful for the support!"
              }
            ].map((story, idx) => (
              <div className="col-lg-4" key={idx}>
                ...
                >
                  <div className="d-flex align-items-center gap-3 mb-3">
                    ...
                    />
                    <div>
                      <h5 className="fw-bold mb-0">{story.name}</h5>
                      <p className="mb-0 small" style={{ opacity: 0.8 }}>{story.role}</p>
                    </div>
                  </div>
                  
                  <div className="mb-3 d-flex justify-content-between">
                    <span style={{ color: '#00AA8A', fontWeight: '600' }}>🏢 {story.company}</span>
                    <span style={{ color: '#FBD21A', fontWeight: '600' }}>💰 {story.package}</span>
                  </div>
                  
                  <p style={{ fontSize: '0.95rem', lineHeight: '1.7', opacity: 0.9, fontStyle: 'italic' }}>
                    "{story.story}"
                  </p>
                </motion.div>
              </div>
